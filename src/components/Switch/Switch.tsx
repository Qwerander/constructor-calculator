...
import { Mode, changeMode } from '../../store/dragSlice';
import { clearScreen, resetOperator, resetResult, resetValue1, resetValue2 } from '../../store/calcSlice';
...
export const Switch = () => {
    ...
    return (
        <SwitchStyled onClick={() => toggleMode()}>
            <div className={`${mode === Mode.CALC ? 'active' : ''}`}>
            ...
            <div className={`${mode === Mode.CONSTRUCTOR ? 'active' : ''}`}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.49984 13.3333L4.1665 10L7.49984 6.66668M12.4998 6.66668L15.8332 10L12.4998 13.3333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                Constructor
            </div>
        </SwitchStyled>
    );
